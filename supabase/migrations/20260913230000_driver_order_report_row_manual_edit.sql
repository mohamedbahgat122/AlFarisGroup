-- Permit audited, organization-scoped corrections to imported Order Report metrics.
create or replace function public.organization_permission_keys() returns text[]
language sql stable set search_path = '' as $$
  select array[
    ...
    'driver_reports.replace', 'driver_reports.details.view',
    'driver_order_reports.view', 'driver_order_reports.import',
    'driver_order_reports.replace', 'driver_order_reports.details.view',
    'driver_order_reports.edit',
    'fleet.cars.view', 'fleet.motorcycles.view', 'fleet.create', 'fleet.update',
    ...
    -- Retain historical entitlement permission rows without exposing them in Admin.
...
create or replace function public.view_only_organization_permission_keys() returns text[]
language sql immutable security definer set search_path = '' as $$
  select array[
    'organization.dashboard.view', 'drivers.view', 'driver_reports.view',
    'driver_order_reports.view', 'fleet.cars.view', 'fleet.motorcycles.view',
    'fuel.reports.view', 'app_requests.view', 'odometer.manage',
    'notifications.view', 'driver_warnings.view', 'entitlements.view',
...
create or replace function public.update_driver_order_daily_report_row(
