...
begin
  ...
  insert into public.organization_order_period_operational_policies (
    ...
    v_before.close_after_minutes, p_minimum_work_minutes, v_actor, v_actor
...
begin
  ...
  if v_shift.applied_minimum_work_minutes is null then raise exception 'ORDER_PERIOD_END_POLICY_UNCONFIGURED' using errcode = '42501'; end if;
