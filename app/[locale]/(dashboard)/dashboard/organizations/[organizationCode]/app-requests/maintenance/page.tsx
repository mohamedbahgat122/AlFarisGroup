...
export async function generateMetadata({ params }: RouteProps): Promise<Metadata> {
  ...
  return { title: dictionary.maintenanceTitle, robots: { index: false, follow: false } };
}

export default async function MaintenanceRequestsRoute({ params, searchParams }: RouteProps) {
  ...
  return (
    <RequestPage
      ...
      title={dictionary.maintenanceTitle}
