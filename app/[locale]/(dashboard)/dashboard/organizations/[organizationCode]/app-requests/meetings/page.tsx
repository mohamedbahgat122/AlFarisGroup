...
export async function generateMetadata({ params }: RouteProps): Promise<Metadata> {
  ...
  return { title: dictionary.meetingsTitle, robots: { index: false, follow: false } };
}

export default async function MeetingRequestsRoute({ params, searchParams }: RouteProps) {
  ...
  return (
    <RequestPage
      ...
      requestType="meeting"
      title={dictionary.meetingsTitle}
